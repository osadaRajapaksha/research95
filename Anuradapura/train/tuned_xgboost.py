...
grid_search = GridSearchCV(xgb, param_grid, cv=5, scoring='balanced_accuracy', n_jobs=-1)
...
plt.tight_layout()
plt.savefig('Feature_Importance_Tuned_XGB.png', dpi=300)
print("Saved -> 'Feature_Importance_Tuned_XGB.png'")
