...
print("\n9. Saving Feature Importance Chart...")
...
plt.title('SMOTE + Tuned XGBoost - Feature Importance')
plt.tight_layout()
plt.savefig('Feature_Importance_SMOTE_Tuned_XGB.png', dpi=300)
print("Saved -> 'Feature_Importance_SMOTE_Tuned_XGB.png'")
